...
namespace smashclone
{
    public class playerControl : MonoBehaviourPun, IPunObservable
    {
        ...
        {
            if (other.tag == "platforms" && transform.position.y > other.transform.position.y || other.tag == "spawnplatform" && transform.position.y > other.transform.position.y)
            {
                allowJump = true;
                animPlayer.SetBool("jump", !allowJump);
            }
